...
public class MyAdapter extends RecyclerView.Adapter<MyAdapter.NewsViewHolder> {
    ...
    public MyAdapter.NewsViewHolder onCreateViewHolder(ViewGroup viewGroup,int i){
        View v= LayoutInflater.from(context).inflate(R.layout.news_item,viewGroup,false);
        NewsViewHolder nvh=new NewsViewHolder(v);
        return nvh;
    }
    @Override
    public void onBindViewHolder(MyAdapter.NewsViewHolder personViewHolder, int i) {
        final int j=i;
